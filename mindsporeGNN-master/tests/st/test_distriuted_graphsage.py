...
def test_distributed_graphsage():
    """
    Feature: test distributed graphsage

    Description:test distributed graphsage training file
    ...
    if os.path.exists('ci_temp/dist/graphsage'):
        shutil.rmtree('ci_temp/dist/graphsage')

    cmd_copy = "cp -r ../../model_zoo/graphsage/ ./ci_temp/dist/"
    os.system(cmd_copy)
