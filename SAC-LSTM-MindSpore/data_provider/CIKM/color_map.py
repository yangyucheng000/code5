...
if __name__ == "__main__":
    img_path = "/data/data-home/shelei/self_data/gen_frame/PFST-SOURCE/train_727_pfst_retrain_dataloader_use_test/sample_1/img_10.png"
    des_path = "/data/data-home/shelei/self_data/gen_frame/PFST-SOURCE/color_map/sample_2/img_10.png"
    # if not os.path.exists(des_path)
    a = time.time()
