...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess):
        ...
        self.train = torchvision.datasets.ImageFolder('imagenet_path', transform=train_preprocess)
        self.val = torchvision.datasets.ImageFolder('imagenet_path', transform=test_preprocess)
        self.test = torchvision.datasets.ImageFolder('imagenet_path', transform=test_preprocess)
