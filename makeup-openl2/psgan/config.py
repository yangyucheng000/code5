...
_C.LOG = CfgNode()
_C.LOG.LOG_PATH = './log/log_net_dran/'
...
# Data settings
_C.DATA = CfgNode()
_C.DATA.PATH = 'dataset/psgan-data-expand-lms280'
...
_C.TRAINING = CfgNode()
_C.TRAINING.SOLVER = 'nolocal_nowarp'
_C.TRAINING.WINDOWS = -10086
...
_C.PREPROCESS.FACE_CLASS = [1, 6, 2, 3, 4,5]
_C.PREPROCESS.LANDMARK_POINTS = 280
